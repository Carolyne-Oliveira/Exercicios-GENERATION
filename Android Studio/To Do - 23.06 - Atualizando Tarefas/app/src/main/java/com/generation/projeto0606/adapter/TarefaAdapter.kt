...
import com.generation.projeto0606.MainViewModel
...
class TarefaAdapter (
    ...
    override fun onBindViewHolder(holder: TarefaViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            taskClickListener.onTasckClickListener(tarefa)
        }
    ...
    fun setList(list: List<Tarefa>){
        listTarefa = list.sortedByDescending { it.id } //listar a tarefa de forma decrescente.
